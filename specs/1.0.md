...
## $.groups.$.icon
The icon representing your group. This field is optional.
...
Example:  
For an icon named **my-model-icon.svg**, you would type
```
 - icon: res://my-model-icon.svg
```
