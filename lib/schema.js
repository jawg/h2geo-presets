...
var stringValuesTagSchema = {
  ...
  "properties": {
    "key": {"type": "string", "required": true},
    "type": {"enum": ["TEXT", "NUMBER", "SINGLE_CHOICE", "MULTI_CHOICE", "SINGLE_CHOICE_IMAGE", "MULTI_CHOICE_IMAGE", "COLOR", "OPENING_HOURS", "LEVEL"], "required": true},
    "description": {"$ref": "/I18NOptional"},
    "value": {"$ref": "/I18NOptional"},
    "values": {"type": "array", "items": {"$ref": "/TagValue"}},
    "images": {"type": "array", "items": {"$ref": "/Resource"}},
    "statement": {"$ref": "/I18NOptional"},
    "required": {"type": "boolean"},
    "show": {"type": "boolean"},
    "editable": {"type": "boolean"},
