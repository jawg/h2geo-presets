...
var constantTagSchema = {
  ...
  "properties": {
    ...
    "description": {"type": "object", "patternProperties": {"[a-z]+": {"type": "string"}}},
...
var stringValuesTagSchema = {
  ...
  "properties": {
    "key": {"type": "string", "required": true},
    "type": {"enum": ["TEXT", "SINGLE_CHOICE", "MULTI_CHOICE", "OPENING_HOURS"], "required": true},
    "description": {"type": "object", "patternProperties": {"[a-z]+": {"type": "string"}}},
...
var itemSchema = {
  ...
  "properties": {
    ...
    "url": {"type": "string"},
    "label": {"type": "object", "patternProperties": {"[a-z]+": {"type": "string"}}, "required": true},
    "description": {"type": "object", "patternProperties": {"[a-z]+": {"type": "string"}}, "required": true},
    "keywords": {
      "type": "object",
      "patternProperties": {"[a-z]+": {"type": "array", "items": {"type": "string"}}},
      "required": true
    },
...
var groupSchema = {
  ...
  "type": "object",
  "properties": {
    "name": {"type": "object", "patternProperties": {"[a-z]+": {"type": "string"}}, "required": true},
    "icon": {"type": "string"},
    "url": {"type": "string"},
